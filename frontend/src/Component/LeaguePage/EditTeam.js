...
function EditTeam() {
  ...
  function UpdateTeam(e) {
    ...
    try {
      axios.put(`https://premier-league-management-production.up.railway.app/api/clubs/${teamid}`, updateTeam);
  ...
  function DeleteTeam(e) {
    ...
    try {
      axios.post(`https://premier-league-management-production.up.railway.app/api/clubs/${teamid}`, deleteTeam);
